...
public class ShadowBox {
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (SHADOW_DISTANCE * Math.tan(Math.toRadians(MasterRenderer.getFOV())));
		nearWidth = (float) (MasterRenderer.getNearPlane() * Math.tan(Math.toRadians(MasterRenderer.getFOV())));
